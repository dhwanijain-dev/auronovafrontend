...
export default function AdminSidebar({ open, setOpen }: SidebarProps) {
    ...
    const [navigation, setNavigation] = useState<NavItem[]>([
        { name: "Dashboard", href: "/user", icon: LayoutDashboard, current: true },
        { name: "Users", href: "/user/users", icon: Users, current: false },
        { name: "Products", href: "/user/products", icon: ShoppingCart, current: false },
        { name: "Analytics", href: "/user/analytics", icon: BarChart, current: false },
