...
interface StallPerformanceData {
  name: string;
  orders: number;
  revenue: number;
  avgQueueTime: number;
...
const stallPerformanceData: StallPerformanceData[] = [
...
const foodCategoryData: FoodCategoryData[] = [
...
const getWaitTimeIcon = (current: number, previous: number) => {
